// ============================================================================ //
// 🛠️ EMPLOYER ID (EIN) APPLICATION VALIDATION MATRIX ENGINE (PART 1 OF 5)
// ============================================================================ //
const einApplicationPart1Validation = {
  requiredFields: [
...
function buildEinApplicationPart1(stateDropdownOptionsHtml = "") {
  return `
    ...
    <div style="grid-column: span 2; background: rgba(10, 31, 68, 0.03); border-left: 4px solid var(--navy); padding: 14px; border-radius: 0 8px 8px 0; font-size: 0.8rem; line-height: 1.4; color: var(--slate); box-sizing: border-box; margin-bottom: 8px;">
      <strong style="color: var(--navy); display: block; margin-bottom: 4px;"><i class="fa-solid fa-circle-info"></i> Federal Tax Identification Standards</strong> An Employer Identification Number (EIN), also recognized as a Federal Tax Identification Number, is a unique nine-digit numerical identifier assigned by the Internal Revenue Service (IRS). It is a structural mandate for establishing commercial banking facilities, hiring payroll personnel, maintaining clear corporate transparency shields, and filing corporate tax returns.
    </div>
    ...
    <div class="wizard-input-group" style="grid-column: span 1;">
      ...
      <input type="text" id="ein_applicant_name" required placeholder="Individual primary registrant full name or legal corporate title" class="wizard-input-field">
    </div>
...
// Global window registration assignments
if (!window.formRegistry) window.formRegistry = {};
window.formRegistry['ein-application-part1-layout'] = buildEinApplicationPart1;
window.formRegistry['ein-application-part1-validation'] = einApplicationPart1Validation;

// ============================================================================ //
// 🛠️ EMPLOYER ID (EIN) APPLICATION VALIDATION MATRIX ENGINE (PART 2 OF 5)
// ============================================================================ //
const einApplicationPart2Validation = {
  requiredFields: [
...
if (!window.formRegistry) window.formRegistry = {};
window.formRegistry['ein-application-part2-layout'] = buildEinApplicationPart2;
window.formRegistry['ein-application-part2-validation'] = einApplicationPart2Validation;

// ============================================================================ //
// 🛠️ EMPLOYER ID (EIN) APPLICATION VALIDATION MATRIX ENGINE (PARTS 3, 4 & 5)
// ============================================================================ //
const einApplicationRemainingValidation = {
  requiredFields: [
  ...
  validateStep: function() {
    ...
    // 3. Validate Responsible Party Taxpayer Identification Format (9-Digits SSN/ITIN check)
    ...
    // 4. Validate Optional Prior Historical EIN Format if filled
...
window.buildEinApplicationPart3 = buildEinApplicationPart3;
...
window.buildEinApplicationPart4 = buildEinApplicationPart4;
...
window.buildEinApplicationPart5 = buildEinApplicationPart5;

// 📦 MASTER EMPLOYER ID (EIN) APPLICATION ASSEMBLY HOOK
...
// Global registry setup matrix tracking allocation routes
if (!window.formRegistry) window.formRegistry = {};
window.formRegistry['ein-application-part3-layout'] = buildEinApplicationPart3;
window.formRegistry['ein-application-part4-layout'] = buildEinApplicationPart4;
window.formRegistry['ein-application-part5-layout'] = buildEinApplicationPart5;
window.formRegistry['ein-application-remaining-validation'] = einApplicationRemainingValidation;
window.formRegistry['ein-application-form-master'] = buildEinApplicationForm;

// ============================================================================ //
// ⚙️ INTERACTIVE INTERFACE CONTROLLERS (EIN FORM CONTEXTS)
// ============================================================================ //
