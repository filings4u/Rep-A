function validateDunsNumberFormPart1() {
  let isValid = true;
...
function buildDunsNumberFormPart1(stateDropdownOptionsHtml = "") {
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   ...
   <input type="text" id="duns_legal_name" required placeholder="Enter exact legal name matching state incorporation records" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <input type="text" id="duns_trade_name" placeholder="Assumed name under which you conduct business" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 </div>
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <input type="text" id="duns_federal_ein" required placeholder="00-0000000" pattern="[0-9]{2}-[0-9]{7}" title="Standard 9-digit EIN required (XX-XXXXXXX)" class="wizard-input-field" style="font-family: monospace; width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   ...
   <input type="text" id="duns_physical_street" required placeholder="Physical Location Address, Suite, Unit (No P.O. Boxes allowed by D&B)" class="wizard-input-field" style="width: 100%; box-sizing: border-box;" onfocus="attachGooglePlacesAutocompleteToNode(this, 'duns_physical')">
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 16px; width: 100%; box-sizing: border-box;">
     <div>
       ...
       <input type="text" id="duns_physical_city" required placeholder="City" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
     ...
     <div>
       ...
       <select id="duns_physical_state" required class="wizard-input-field" style="font-weight: 600; width: 100%; box-sizing: border-box;">
     ...
     <div>
       ...
       <input type="text" id="duns_physical_zip" required placeholder="Zip Code" style="font-family: monospace; width: 100%; box-sizing: border-box;" class="wizard-input-field">
 ...
 <!-- FIELD 5: LEGAL STRUCTURE CLASSIFICATION (FIXED OPENING TAG) -->
 <div class="wizard-input-group" style="grid-column: span 2;">
   ...
   <select id="duns_legal_structure" required class="wizard-input-field" style="font-weight: 600; width: 100%; box-sizing: border-box;">
...
function validateDunsNumberFormParts2And3() {
  let isValid = true;
...
function buildDunsNumberFormPart2(stateDropdownOptionsHtml = "") {
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <input type="number" id="duns_employee_count" required placeholder="1" min="1" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <select id="duns_annual_revenue_bracket" required class="wizard-input-field" style="font-weight: 600; width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   ...
   <select id="duns_hierarchy_type" required class="wizard-input-field" style="font-weight: 600; width: 100%; box-sizing: border-box;" onchange="toggleDunsParentCompanyVisibility(this.value)">
 ...
 <div id="duns_parent_wrapper" style="grid-column: span 2; display: none; background: #ffffff; border: 1px solid var(--border); padding: 16px; border-radius: 8px; box-sizing: border-box; grid-template-columns: 2fr 1fr; gap: 16px;">
   ...
   <div class="wizard-input-group" style="margin: 0;">
     ...
     <input type="text" id="duns_parent_legal_name" placeholder="Official Corporation or Holding Title" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
   ...
   <div class="wizard-input-group" style="margin: 0;">
     ...
     <input type="text" id="duns_parent_country" placeholder="e.g. United States" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
...
function buildDunsNumberFormPart3(stateDropdownOptionsHtml = "") {
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   <label for="duns_executive_name" style="font-weight: 700; font-size: 0.85rem; text-transform: uppercase; color: var(--navy);">Executive Officer Officer Full Legal Name <span style="color: #ef4444;">*</span></label>
   <input type="text" id="duns_executive_name" required placeholder="First and Last Legal Name" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <input type="text" id="duns_executive_title" required placeholder="e.g., Managing Member, President, CEO, Owner" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 1;">
   ...
   <input type="tel" id="duns_executive_phone" required placeholder="(512) 555-0199" class="wizard-input-field" style="width: 100%; box-sizing: border-box;">
 ...
 <div class="wizard-input-group" style="grid-column: span 2;">
   ...
   <textarea id="duns_provisions" placeholder="Detail any explicit credit tracking priorities, specialized trade vendor onboarding deadlines, or proxy filing parameters required for your Dun & Bradstreet company profile setup..." class="wizard-input-field" style="width: 100%; min-height: 80px; box-sizing: border-box; padding: 12px; font-family: inherit; resize: vertical; border: 1px solid var(--border); border-radius: 6px; font-weight: 600;"></textarea> </div> </div>
 `;
}

// 📦 MASTER DUNS NUMBER CONFIGURATION APPLICATION ASSEMBLY HOOK
...
/**
 * Scans all field parameters inside the DUNS Number Registration Wizard.
 ...
 */
function validateEntireDunsNumberWizard() {
  const isPart1Valid = typeof validateDunsNumberFormPart1 === 'function' ? validateDunsNumberFormPart1() : true;
  const isPart23Valid = validateDunsNumberFormParts2And3();
