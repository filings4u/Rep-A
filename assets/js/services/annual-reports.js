    ...
    window.formRegistry['annual-reports-validation-engine'] = {
        ...
        validate: function() {
            ...
            this.requiredFields.forEach(f => {
                ...
                // Run alpha-numeric check for long list fields, regular trim check for standard fields
...
return ` 
 ...
 <strong style="color: var(--navy, #0a1f44); display: block; margin-bottom: 4px;"><i class="fa-solid fa-circle-info"></i> What is an Annual Report Filing?</strong> An Annual Report is a mandatory periodic filing required to maintain active legal standing. 
 </div> 
 ...
 <!-- Dropdown with a longer label forced to single row layout to prevent wrapping text --> 
 ...
 <!-- Dropdown selector with long text, isolated to its own full row layout --> 
 <div class="wizard-input-group" style="grid-column: span 2; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
 ...
 <h4 style="color: var(--navy, #0a1f44); font-size: 0.95rem; font-weight: 700; margin: 0;">Alternate Mailing Address</h4> </div> 
 ...
 <!-- Contact Metadata Input Section (Full row name, side-by-side phone/email) --> 
 <div class="wizard-input-group" style="grid-column: span 2; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
...
return ` 
 ...
 <!-- Long Text Field Area: Forced to a single full-width row to avoid text wrapping --> 
 ...
 <div style="grid-column: span 2; border-bottom: 1px solid var(--border, #e2e8f0); padding-bottom: 8px; margin-top: 10px; margin-bottom: 16px;"> 
 <h3 style="color: var(--navy, #0a1f44); font-size: 1.1rem; font-weight: 800; margin: 0;">4. City Filings</h3> </div> 

 <!-- Side-by-Side Row: License ID field and associated target Date input picker --> 
 <div class="wizard-input-group" style="grid-column: span 1; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
 ...
 <!-- Single Row Layout: Dropdown containing options with long wrapped text values --> 
 <div class="wizard-input-group" style="grid-column: span 2; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
 ...
 <!-- Long Text Field Area: Assigned to full single row grid space --> 
 ...
 <div style="grid-column: span 2; border-bottom: 1px solid var(--border, #e2e8f0); padding-bottom: 8px; margin-top: 10px; margin-bottom: 16px;"> 
 <h3 style="color: var(--navy, #0a1f44); font-size: 1.1rem; font-weight: 800; margin: 0;">5. Federal Filings</h3> </div> 

 <!-- Side-by-Side Row: Standard string format identification field paired with standard Dropdown --> 
 <div class="wizard-input-group" style="grid-column: span 1; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
...
return ` 
 ...
 <!-- Forced to full row: Text string label is too long and would wrap tightly if paired -->
 <div class="wizard-input-group" style="grid-column: span 2; margin-bottom: 20px; display: flex; flex-direction: column; gap: 6px;"> 
 ...
 <!-- Long Text Field Area: Expands full-width -->
 ...
 <div style="grid-column: span 2; border-bottom: 1px solid var(--border, #e2e8f0); padding-bottom: 8px; margin-top: 10px; margin-bottom: 16px;"> 
 <h3 style="color: var(--navy, #0a1f44); font-size: 1.1rem; font-weight: 800; margin: 0;">7. Compliance Check</h3> </div> 
 ...
 <!-- Dynamic Overlay Area: Long Text Field assigned to single full row layout --> 
 ...
 <div style="grid-column: span 2; border-bottom: 1px solid var(--border, #e2e8f0); padding-bottom: 8px; margin-top: 10px; margin-bottom: 16px;"> 
 <h3 style="color: var(--navy, #0a1f44); font-size: 1.1rem; font-weight: 800; margin: 0;">8. Additional Provisions</h3> </div> 
`; 
};
