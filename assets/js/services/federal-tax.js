// ============================================================================ //
// 🛠️ FEDERAL INCOME TAX FILING VALIDATION MATRIX ENGINE (PART 1 OF 3)
// ============================================================================ //
const federalIncomeTaxPart1Validation = {
  requiredFields: [
...
function buildFederalIncomeTaxFormPart1(stateDropdownOptionsHtml) {
  ...
  return `
    ...
    <div style="grid-column: span 2; background: rgba(10, 31, 68, 0.03); border-left: 4px solid var(--navy); padding: 14px; border-radius: 0 8px 8px 0; font-size: 0.8rem; line-height: 1.4; color: var(--slate); box-sizing: border-box; margin-bottom: 8px;">
      <strong style="color: var(--navy); display: block; margin-bottom: 4px;"><i class="fa-solid fa-circle-info"></i> Federal Corporate Tax Filing Compliance</strong> All registered business entities must file an annual federal income tax return with the Internal Revenue Service (IRS), regardless of whether the business generated active revenue. The specific return layout and filing milestones depend directly on your formal IRS tax classification (e.g., Form 1065 for partnerships, Form 1120 for C-corporations, or Form 1120-S for S-corporations).
    </div>
...
window.formRegistry['federal-income-tax-part1-layout'] = buildFederalIncomeTaxFormPart1;
window.formRegistry['federal-income-tax-part1-validation'] = federalIncomeTaxPart1Validation;

// ============================================================================ //
// 🛠️ FEDERAL INCOME TAX FILING REMAINING SECTIONS VALIDATION ENGINE (PARTS 2-5)
// ============================================================================ //
const federalIncomeTaxRemainingValidation = {
  requiredFields: [
  ...
  validateStep: function() {
    ...
    // 2. Validate Financial Ledger Range Metrics
    ...
    // 3. Conditional Check: Validate Cost of Goods Sold if inventory matches YES
...
window.buildFederalIncomeTaxFormPart2 = buildFederalIncomeTaxFormPart2;
...
window.buildFederalIncomeTaxFormPart3 = buildFederalIncomeTaxFormPart3;
...
window.buildFederalIncomeTaxFormPart4 = buildFederalIncomeTaxFormPart4;
...
window.buildFederalIncomeTaxFormPart5 = buildFederalIncomeTaxFormPart5;

// 📦 MASTER FEDERAL INCOME TAX APPLICATION ASSEMBLY HOOK
...
if (!window.formRegistry) window.formRegistry = {};
window.formRegistry['federal-income-tax-part2-layout'] = buildFederalIncomeTaxFormPart2;
window.formRegistry['federal-income-tax-part3-layout'] = buildFederalIncomeTaxFormPart3;
window.formRegistry['federal-income-tax-part4-layout'] = buildFederalIncomeTaxFormPart4;
window.formRegistry['federal-income-tax-part5-layout'] = buildFederalIncomeTaxFormPart5;
window.formRegistry['federal-income-tax-remaining-validation'] = federalIncomeTaxRemainingValidation;
window.formRegistry['federal-income-tax-form-master'] = buildFederalIncomeTaxForm;

// ============================================================================ //
// ⚙️ INTERACTIVE INTERFACE CONTROLLERS (FEDERAL INCOME TAX FILINGS)
// ============================================================================ //
...
window.toggleFederalTaxInventoryCostVisibility = function(value) {
  ...
  if (value === "yes") {
    ...
    if (cogsInput) { cogsInput.removeAttribute("required"); cogsInput.value = ""; }
  }
};