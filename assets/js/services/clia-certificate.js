// ============================================================================ //
// 🛠️ CLIA CERTIFICATE REGISTRATION VALIDATION MATRIX ENGINE (PART 1 OF 3)
// ============================================================================ //
const cliaCertificatePart1Validation = {
  requiredFields: [
...
// Global registry window configuration mapper allocations
if (!window.formRegistry) window.formRegistry = {};
window.formRegistry['clia-certificate-part1-layout'] = buildCliaCertificatePart1;
window.formRegistry['clia-certificate-part1-validation'] = cliaCertificatePart1Validation;

// ============================================================================ //
// 🛠️ CLIA CERTIFICATE REGISTRATION VALIDATION MATRIX ENGINE (PARTS 2 & 3)
// ============================================================================ //
const cliaCertificateRemainingValidation = {
  requiredFields: [
    ...
    { id: 'clia_tax_id', msg: 'Federal Tax Identification Number (EIN) is required.' },
  ...
  validateStep: function() {
    ...
    // 2. Validate Director Email Layout String Formatting
    ...
    // 3. Validate Director Phone Number Character Length
    const phoneEl = document.getElementById("clia_director_phone");
    if (phoneEl && phoneEl.value.trim()) {
      const cleanDigits = phoneEl.value.replace(/\D/g, "");
      if (cleanDigits.length < 10) setError(phoneEl, "Director / Admin Phone Number must contain at least 10 numbers.");
    }

    // 4. Validate Annual Test Volume Numerical Range Logic
    ...
    // 5. Validate Federal EIN Length Constraint Format (9-Digits)
...
window.buildCliaCertificatePart2 = buildCliaCertificatePart2;
