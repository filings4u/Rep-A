 ...
 * Module: navigation.js (Part 1 - CSS-Class Aligned Structural Canvas)
 */
...
function renderDynamicGlobalCorporateNavigation() {
    try {
        ...
        // 2. Compile structural HTML layouts using your clean class rules natively
        zone.innerHTML = `
...
/* Part 2: Class-Aligned Links Injection & Event Handlers */
(function() {
    const targetId = window.FILINGS4U_NAV_TARGET || "filings4u-global-navigation-root";
    ...
    setTimeout(function() {
        ...
        // 1. Output the exact menu layout blueprint matched to your master.css classes
        const fullMenuHTML = `
<!-- FORMATIONS DROPDOWN --> 
...
<!-- CORPORATE REGISTRATIONS DROPDOWN (New Category for Identifiers & Intellectual Property) -->
<div class="nav-item-dropdown static-dropdown"> 
...
<div class="nav-item-dropdown static-dropdown"> 
    ...
    <!-- 🟢 FIXED: Swapped class to mega-panel-stretch-left to shift the menu body backward toward the left side of the screen -->
...
<a href="https://portal.filings4u.com/client-dashboard.html" class="btn-client-portal">Client Portal</a>
        ...
        // 2. Mobile toggles alignment logic hooks
        ...
        // 3. Mobile accordion submenu alignment adjustments
        ...
        // 4. Click off-canvas dismiss behavior configurations
