...
function renderDynamicWizardApplicationMap() { 
  ...
  const timelineRegistryMatrix = [ 
    ...
    { idx: 1, title: "2. Vehicle Input Matrix", desc: "Items and inclusions" }, 
    { idx: 2, title: "3. Real-Time Tax Review", desc: "Corporate entity details" }, 
    { idx: 3, title: "4. Add-Ons", desc: "Compliance assets & shields" }, 
    { idx: 4, title: "5. Power of Attorney", desc: "Digital signature execution" }, 
    { idx: 5, title: "6. Purchase Summary", desc: "Order item breakdowns" }, 
    { idx: 6, title: "7. Secure Payment", desc: "Encrypted checkout gateway" }, 
    { idx: 7, title: "8. Success Portal", desc: "Account creation systems" } 
  ]; 
