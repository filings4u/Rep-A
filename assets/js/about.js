...
function renderMasterAboutEngine(overrideTargetId) {
    try {
        ...
        aboutHTML += '      <span style="color: #10b981; font-size: 0.85rem; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px; display: block; text-align: center; margin: 0 auto 10px auto; width: fit-content;">Architecting Enterprise Infrastructure</span>';
        aboutHTML += '      <h1 style="font-size: 2.5rem; font-weight: 900; margin: 0 0 6px 0; letter-spacing: -0.5px; text-align: center; width: 100%;">About filings4u</h1>';
        aboutHTML += '    </div>';
        aboutHTML += '  </div>';
